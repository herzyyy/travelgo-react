      ...
      <main className="auth-page">
        <section className="auth-visual" aria-label="Travel inspiration">
          <div className="brand brand-light">
            <span className="brand-mark">✦</span> TravelGo
          </div>
          <div className="visual-copy">
            ...
            <p>
              Curated stays, local experiences, and little moments that make a
              trip feel like yours.
            </p>
          </div>
          <div className="photo-credit">
            SANTORINI, GREECE <span>●</span> 36.39° N, 25.46° E
          </div>
        </section>
        <section className="auth-panel">
          ...
          <div className="auth-form-wrap">
            ...
            <p className="signup-prompt">
              New to TravelGo? <a href="#signup">Create an account</a>
            </p>
  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        <nav>
          {["Explore", "Destinations", "Travel Tips"].map(
            (tab) => (
              <button
                key={tab}
      ...
      {activeTab === "Destinations" ? (
        ...
        <div className="home-content">
          <section className="welcome-row">
            <div>
              <p className="eyebrow">WEDNESDAY, JUNE 18, 2025</p>
              <h1>
                Where to next, <em>Harper?</em>
              </h1>
              <p className="subheading">
                The world is waiting. Let&apos;s find your way into it.
              </p>
            </div>
          ...
          <section className="search-bar">
            <span>⌕</span>
            <input placeholder="Search destinations, stays, or experiences" />
          ...
          <section className="destination-grid">
            {destinations.slice(0, 3).map((destination, index) => (
              <article
                className={`destination-card ${index === 0 ? "tall" : ""}`}
          ...
          <section className="bottom-row">
            ...
            <div className="note-card">
              ...
              <div>
                <strong>Make room for wonder.</strong>
              </div>
            </div>
          </section>
        </div>
